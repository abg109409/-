 ...
 * 			초기화.
 * 
 * 내용 : 화면을 구성하는 콤포넌트를 선언
 *        변수선언규칙 앞 대문자가 어떤 콤포넌트인지 간단하게 표시됨.
 *        P - 패널,  L - 라벨,  B - 버튼, T - 텍스트필드, TA - 멀티텍스트, TABLE - 표
 *        DTB - Default Table Model
 *        
 */
